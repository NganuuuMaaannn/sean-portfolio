...
export default function Header({ showHeader, onAbout, onProjects, onFigma, onTech, onCertificates, onContact }: Props) {
  return (
    ...
    >
      <nav className="flex justify-center items-center gap-2 sm:gap-6 md:gap-8 text-[12px] sm:text-sm md:text-lg font-medium tracking-wide">
        ...
        <a onClick={onFigma} className="text-center hover:opacity-80 transform transition duration-200 ease-in-out hover:scale-105">Figma Projects</a>
