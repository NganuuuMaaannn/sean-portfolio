...
export default async function SeanAdminPage() {
  ...
  return (
    <main className={`relative min-h-screen overflow-hidden text-cyan-50 ${bodyFont.className}`}>
      <div className="cyber-portfolio pointer-events-none absolute inset-0 p-0">
        ...
        <section className="relative z-10 mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6 sm:py-10">
